...
// v1.83.2 is the minimum version fixing GO-2026-6443 (the 1.83.x line is affected again
// until 1.83.2); it also carries the fixes for GO-2026-6348,
// GO-2026-6061 and GO-2026-4762 (authorization bypass via :path).
